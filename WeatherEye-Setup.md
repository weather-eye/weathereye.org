...
---
*Powered by:*
- [Briefcase](https://beeware.org/project/briefcase/) (converting a Python project into a standalone native application)
- [PyWebView](https://pywebview.flowrl.com/) (Allows [[WeatherEye Controller]] to be rendered as a Web UI instead of using through different OS shells)
